...
final checks = <String, ({RegExp pattern, int baseline})>{
  ...
  'material icons': (pattern: RegExp(r'Icons\.'), baseline: 164),
  'raw EdgeInsets': (pattern: RegExp(r'EdgeInsets\.'), baseline: 194),
  ...
  'raw Scaffold': (pattern: RegExp(r'Scaffold\s*\('), baseline: 2),
};
