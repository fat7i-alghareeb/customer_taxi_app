...
/// Centralizes Android picker recovery and file validation for every upload
/// surface. Recovered files are consumed by the next picker request after the
/// OS recreates the activity.
