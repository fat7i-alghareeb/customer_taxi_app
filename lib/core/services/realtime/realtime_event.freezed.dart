...
return driverAssigned(_that);case RealtimeTripAccepted() when tripAccepted != null:
return tripAccepted(_that);case RealtimeTripStarted() when tripStarted != null:
...
return refundLifecycleChanged(_that);case RealtimeDriverEnRoute() when driverEnRoute != null:
...
return driverAssigned(_that);case RealtimeTripAccepted():
return tripAccepted(_that);case RealtimeTripStarted():
...
return refundLifecycleChanged(_that);case RealtimeDriverEnRoute():
...
return driverAssigned(_that.tripId,_that.passengerId,_that.driverId);case RealtimeTripAccepted() when tripAccepted != null:
return tripAccepted(_that.tripId,_that.passengerId,_that.adminId);case RealtimeTripStarted() when tripStarted != null:
...
return refundLifecycleChanged(_that.refundId,_that.paymentId,_that.tripId,_that.passengerId,_that.status,_that.amount,_that.currency,_that.requiresAdminAction,_that.canRetry,_that.sourceType);case RealtimeDriverEnRoute() when driverEnRoute != null:
...
return driverLocationUpdated(_that.tripId,_that.driverId,_that.latitude,_that.longitude,_that.etaToPickupSeconds,_that.distanceToPickupMeters,_that.routeToPickupPolyline);case RealtimeTripStopCompleted() when tripStopCompleted != null:
...
return driverAssigned(_that.tripId,_that.passengerId,_that.driverId);case RealtimeTripAccepted():
return tripAccepted(_that.tripId,_that.passengerId,_that.adminId);case RealtimeTripStarted():
...
return refundLifecycleChanged(_that.refundId,_that.paymentId,_that.tripId,_that.passengerId,_that.status,_that.amount,_that.currency,_that.requiresAdminAction,_that.canRetry,_that.sourceType);case RealtimeDriverEnRoute():
...
return driverLocationUpdated(_that.tripId,_that.driverId,_that.latitude,_that.longitude,_that.etaToPickupSeconds,_that.distanceToPickupMeters,_that.routeToPickupPolyline);case RealtimeTripStopCompleted():
...
@override
int get hashCode => Object.hash(runtimeType,tripId,driverId,latitude,longitude,etaToPickupSeconds,distanceToPickupMeters,routeToPickupPolyline);

@override
String toString() {
  return 'RealtimeEvent.driverLocationUpdated(tripId: $tripId, driverId: $driverId, latitude: $latitude, longitude: $longitude, etaToPickupSeconds: $etaToPickupSeconds, distanceToPickupMeters: $distanceToPickupMeters, routeToPickupPolyline: $routeToPickupPolyline)';
}
...
class RealtimeNoDriverFound implements RealtimeEvent {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RealtimeNoDriverFound&&(identical(other.tripId, tripId) || other.tripId == tripId)&&(identical(other.passengerId, passengerId) || other.passengerId == passengerId));
}
...
@override
String toString() {
  return 'RealtimeEvent.noDriverFound(tripId: $tripId, passengerId: $passengerId)';
}
...
/// @nodoc
class _$RealtimeNoDriverFoundCopyWithImpl<$Res>
    implements $RealtimeNoDriverFoundCopyWith<$Res> {
  _$RealtimeNoDriverFoundCopyWithImpl(this._self, this._then);

  final RealtimeNoDriverFound _self;
  final $Res Function(RealtimeNoDriverFound) _then;
