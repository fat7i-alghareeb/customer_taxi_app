...
/// @nodoc
abstract mixin class $RefundIssueModelCopyWith<$Res>  {
  factory $RefundIssueModelCopyWith(RefundIssueModel value, $Res Function(RefundIssueModel) _then) = _$RefundIssueModelCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$RefundIssueModelCopyWithImpl<$Res>
    implements $RefundIssueModelCopyWith<$Res> {
  _$RefundIssueModelCopyWithImpl(this._self, this._then);

  final RefundIssueModel _self;
  final $Res Function(RefundIssueModel) _then;
...
/// Adds pattern-matching-related methods to [RefundIssueModel].
extension RefundIssueModelPatterns on RefundIssueModel {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _RefundIssueModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _RefundIssueModel() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _RefundIssueModel value)  $default,){
final _that = this;
switch (_that) {
case _RefundIssueModel():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _RefundIssueModel value)?  $default,){
final _that = this;
switch (_that) {
case _RefundIssueModel() when $default != null:
return $default(_that);case _:
...
@pragma('vm:prefer-inline')
_$RefundIssueModelCopyWith<_RefundIssueModel> get copyWith => __$RefundIssueModelCopyWithImpl<_RefundIssueModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$RefundIssueModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RefundIssueModel&&(identical(other.id, id) || other.id == id)&&(identical(other.tripId, tripId) || other.tripId == tripId)&&(identical(other.requestType, requestType) || other.requestType == requestType)&&(identical(other.customerReason, customerReason) || other.customerReason == customerReason)&&(identical(other.reviewStatus, reviewStatus) || other.reviewStatus == reviewStatus)&&(identical(other.createdAtUtc, createdAtUtc) || other.createdAtUtc == createdAtUtc)&&(identical(other.paymentId, paymentId) || other.paymentId == paymentId)&&(identical(other.paymentRefundId, paymentRefundId) || other.paymentRefundId == paymentRefundId)&&(identical(other.tripCancellationId, tripCancellationId) || other.tripCancellationId == tripCancellationId)&&(identical(other.note, note) || other.note == note)&&(identical(other.refundStatusSnapshot, refundStatusSnapshot) || other.refundStatusSnapshot == refundStatusSnapshot)&&(identical(other.refundAmountSnapshot, refundAmountSnapshot) || other.refundAmountSnapshot == refundAmountSnapshot)&&(identical(other.refundCurrencySnapshot, refundCurrencySnapshot) || other.refundCurrencySnapshot == refundCurrencySnapshot)&&(identical(other.tripReferenceCode, tripReferenceCode) || other.tripReferenceCode == tripReferenceCode)&&(identical(other.whatsAppOpened, whatsAppOpened) || other.whatsAppOpened == whatsAppOpened));
}
...
/// @nodoc
abstract mixin class _$RefundIssueModelCopyWith<$Res> implements $RefundIssueModelCopyWith<$Res> {
  factory _$RefundIssueModelCopyWith(_RefundIssueModel value, $Res Function(_RefundIssueModel) _then) = __$RefundIssueModelCopyWithImpl;
@override @useResult
$Res call({
 String id, String tripId, String requestType, String customerReason, String reviewStatus, DateTime createdAtUtc, String? paymentId, String? paymentRefundId, String? tripCancellationId, String? note, String? refundStatusSnapshot, double? refundAmountSnapshot, String? refundCurrencySnapshot, String? tripReferenceCode, bool whatsAppOpened
});
...
/// @nodoc
class __$RefundIssueModelCopyWithImpl<$Res>
    implements _$RefundIssueModelCopyWith<$Res> {
  __$RefundIssueModelCopyWithImpl(this._self, this._then);

  final _RefundIssueModel _self;
  final $Res Function(_RefundIssueModel) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? tripId = null,Object? requestType = null,Object? customerReason = null,Object? reviewStatus = null,Object? createdAtUtc = null,Object? paymentId = freezed,Object? paymentRefundId = freezed,Object? tripCancellationId = freezed,Object? note = freezed,Object? refundStatusSnapshot = freezed,Object? refundAmountSnapshot = freezed,Object? refundCurrencySnapshot = freezed,Object? tripReferenceCode = freezed,Object? whatsAppOpened = null,}) {
  return _then(_RefundIssueModel(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,tripId: null == tripId ? _self.tripId : tripId // ignore: cast_nullable_to_non_nullable
as String,requestType: null == requestType ? _self.requestType : requestType // ignore: cast_nullable_to_non_nullable
as String,customerReason: null == customerReason ? _self.customerReason : customerReason // ignore: cast_nullable_to_non_nullable
