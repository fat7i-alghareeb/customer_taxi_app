...
mixin _$OrderTripResponseModel {
 ...
 String get id; String get referenceCode; String get passengerId; String? get driverId; String get vehicleTypeId; String get status; double get quotedFare; String get currencyCode; DateTime get createdAtUtc; DateTime? get scheduledAtUtc; List<OrderTripStopModel> get stops; OrderStripePaymentModel? get stripePayment; String? get passengerNote;
...
@useResult
$Res call({
 String id, String referenceCode, String passengerId, String? driverId, String vehicleTypeId, String status, double quotedFare, String currencyCode, DateTime createdAtUtc, DateTime? scheduledAtUtc, List<OrderTripStopModel> stops, OrderStripePaymentModel? stripePayment, String? passengerNote
});
...
as OrderStripePaymentModel?,passengerNote: freezed == passengerNote ? _self.passengerNote : passengerNote // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
/// Create a copy of OrderTripResponseModel
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String referenceCode,  String passengerId,  String? driverId,  String vehicleTypeId,  String status,  double quotedFare,  String currencyCode,  DateTime createdAtUtc,  DateTime? scheduledAtUtc,  List<OrderTripStopModel> stops,  OrderStripePaymentModel? stripePayment,  String? passengerNote)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _OrderTripResponseModel() when $default != null:
return $default(_that.id,_that.referenceCode,_that.passengerId,_that.driverId,_that.vehicleTypeId,_that.status,_that.quotedFare,_that.currencyCode,_that.createdAtUtc,_that.scheduledAtUtc,_that.stops,_that.stripePayment,_that.passengerNote);case _:
  return orElse();
...
class _OrderTripResponseModel extends OrderTripResponseModel {
  const _OrderTripResponseModel({required this.id, required this.referenceCode, required this.passengerId, this.driverId, required this.vehicleTypeId, required this.status, required this.quotedFare, required this.currencyCode, required this.createdAtUtc, this.scheduledAtUtc, required final  List<OrderTripStopModel> stops, this.stripePayment, this.passengerNote}): _stops = stops,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,referenceCode,passengerId,driverId,vehicleTypeId,status,quotedFare,currencyCode,createdAtUtc,scheduledAtUtc,const DeepCollectionEquality().hash(_stops),stripePayment,passengerNote);
