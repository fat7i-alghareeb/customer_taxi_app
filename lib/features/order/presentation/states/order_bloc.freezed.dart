...
return passengerNoteChanged(_that);case _FlightNumberChanged() when flightNumberChanged != null:
return flightNumberChanged(_that);case _ConfirmBookingDetailsPressed() when confirmBookingDetailsPressed != null:
return confirmBookingDetailsPressed(_that);case _PaymentSheetDismissed() when paymentSheetDismissed != null:
return paymentSheetDismissed(_that);case _WalletBalanceRequested() when walletBalanceRequested != null:
return walletBalanceRequested(_that);case _PaymentMethodSelected() when paymentMethodSelected != null:
return paymentMethodSelected(_that);case _:
  return orElse();
...
return passengerNoteChanged(_that);case _FlightNumberChanged():
return flightNumberChanged(_that);case _ConfirmBookingDetailsPressed():
return confirmBookingDetailsPressed(_that);case _PaymentSheetDismissed():
return paymentSheetDismissed(_that);case _WalletBalanceRequested():
return walletBalanceRequested(_that);case _PaymentMethodSelected():
return paymentMethodSelected(_that);case _:
...
return passengerNoteChanged(_that.note);case _FlightNumberChanged() when flightNumberChanged != null:
return flightNumberChanged(_that.flightNumber);case _ConfirmBookingDetailsPressed() when confirmBookingDetailsPressed != null:
return confirmBookingDetailsPressed();case _PaymentSheetDismissed() when paymentSheetDismissed != null:
return paymentSheetDismissed();case _WalletBalanceRequested() when walletBalanceRequested != null:
return walletBalanceRequested();case _PaymentMethodSelected() when paymentMethodSelected != null:
return paymentMethodSelected(_that.method);case _:
  return orElse();
...
return passengerNoteChanged(_that.note);case _FlightNumberChanged():
return flightNumberChanged(_that.flightNumber);case _ConfirmBookingDetailsPressed():
return confirmBookingDetailsPressed();case _PaymentSheetDismissed():
return paymentSheetDismissed();case _WalletBalanceRequested():
return walletBalanceRequested();case _PaymentMethodSelected():
return paymentMethodSelected(_that.method);case _:
  throw StateError('Unexpected subclass');
...
class _FlightNumberChanged implements OrderEvent {
  const _FlightNumberChanged(this.flightNumber);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$FlightNumberChangedCopyWith<_FlightNumberChanged> get copyWith => __$FlightNumberChangedCopyWithImpl<_FlightNumberChanged>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _FlightNumberChanged&&(identical(other.flightNumber, flightNumber) || other.flightNumber == flightNumber));
}
...
@override
String toString() {
  return 'OrderEvent.flightNumberChanged(flightNumber: $flightNumber)';
}
...
/// @nodoc
abstract mixin class _$FlightNumberChangedCopyWith<$Res> implements $OrderEventCopyWith<$Res> {
  factory _$FlightNumberChangedCopyWith(_FlightNumberChanged value, $Res Function(_FlightNumberChanged) _then) = __$FlightNumberChangedCopyWithImpl;
@useResult
$Res call({
 String flightNumber
});
...
/// @nodoc
class __$FlightNumberChangedCopyWithImpl<$Res>
    implements _$FlightNumberChangedCopyWith<$Res> {
  __$FlightNumberChangedCopyWithImpl(this._self, this._then);

  final _FlightNumberChanged _self;
  final $Res Function(_FlightNumberChanged) _then;

/// Create a copy of OrderEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? flightNumber = null,}) {
  return _then(_FlightNumberChanged(
null == flightNumber ? _self.flightNumber : flightNumber // ignore: cast_nullable_to_non_nullable
as String,
  ));
}
...
class _WalletBalanceRequested implements OrderEvent {
  const _WalletBalanceRequested();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WalletBalanceRequested);
}
...
@override
String toString() {
  return 'OrderEvent.walletBalanceRequested()';
}
...
class _PaymentMethodSelected implements OrderEvent {
  const _PaymentMethodSelected(this.method);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$PaymentMethodSelectedCopyWith<_PaymentMethodSelected> get copyWith => __$PaymentMethodSelectedCopyWithImpl<_PaymentMethodSelected>(this, _$identity);



@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _PaymentMethodSelected&&(identical(other.method, method) || other.method == method));
}
...
@override
String toString() {
  return 'OrderEvent.paymentMethodSelected(method: $method)';
}
...
/// @nodoc
abstract mixin class _$PaymentMethodSelectedCopyWith<$Res> implements $OrderEventCopyWith<$Res> {
  factory _$PaymentMethodSelectedCopyWith(_PaymentMethodSelected value, $Res Function(_PaymentMethodSelected) _then) = __$PaymentMethodSelectedCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class __$PaymentMethodSelectedCopyWithImpl<$Res>
    implements _$PaymentMethodSelectedCopyWith<$Res> {
  __$PaymentMethodSelectedCopyWithImpl(this._self, this._then);

  final _PaymentMethodSelected _self;
  final $Res Function(_PaymentMethodSelected) _then;

/// Create a copy of OrderEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') $Res call({Object? method = null,}) {
  return _then(_PaymentMethodSelected(
