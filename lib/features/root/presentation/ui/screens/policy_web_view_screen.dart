...
///
/// The text used to be duplicated into the locale files and rendered natively,
/// which meant every legal correction needed an app release and nine
/// translations. These documents now live on the website and are shown here, so
/// the published page is always the one the rider agreed to.
