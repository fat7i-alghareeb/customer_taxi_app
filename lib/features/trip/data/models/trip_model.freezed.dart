...
@useResult
$Res call({
 String id, String referenceCode, String status, double quotedFare, String currencyCode, DateTime createdAtUtc, DateTime? scheduledAtUtc, DateTime? arrivedAtUtc, List<TripStopModel> stops, String? vehicleTypeName, double? driverLat, double? driverLng, DateTime? etaToPickup, TripCancellationModel? cancellation, TripRefundModel? refund, TripCompensationClaimModel? compensationClaim, TripWaitingSessionModel? activeWaitingSession, String? encodedOverviewPolyline, List<TripRouteSegmentModel> routeSegments, String? passengerNote, int? passengerRating, String? ratingComment, String? acceptedByAdminId, String? acceptedAdminName, DateTime? acceptedAtUtc, bool isScheduled, DateTime? dispatchWindowOpensAtUtc, bool canMarkEnRoute, String attentionState, int passengerCount, int bagCount, bool noDriverDecisionRequired
});


$TripCancellationModelCopyWith<$Res>? get cancellation;$TripRefundModelCopyWith<$Res>? get refund;$TripCompensationClaimModelCopyWith<$Res>? get compensationClaim;$TripWaitingSessionModelCopyWith<$Res>? get activeWaitingSession;
...
as TripRefundModel?,compensationClaim: freezed == compensationClaim ? _self.compensationClaim : compensationClaim // ignore: cast_nullable_to_non_nullable
...
class _TripModel implements TripModel {
  const _TripModel({required this.id, required this.referenceCode, required this.status, required this.quotedFare, required this.currencyCode, required this.createdAtUtc, this.scheduledAtUtc, this.arrivedAtUtc, final  List<TripStopModel> stops = const [], this.vehicleTypeName, this.driverLat, this.driverLng, this.etaToPickup, this.cancellation, this.refund, this.compensationClaim, this.activeWaitingSession, this.encodedOverviewPolyline, final  List<TripRouteSegmentModel> routeSegments = const [], this.passengerNote, this.passengerRating, this.ratingComment, this.acceptedByAdminId, this.acceptedAdminName, this.acceptedAtUtc, this.isScheduled = false, this.dispatchWindowOpensAtUtc, this.canMarkEnRoute = false, this.attentionState = 'Normal', this.passengerCount = 1, this.bagCount = 0, this.noDriverDecisionRequired = false}): _stops = stops,_routeSegments = routeSegments;
...
@override $TripCancellationModelCopyWith<$Res>? get cancellation;@override $TripRefundModelCopyWith<$Res>? get refund;@override $TripCompensationClaimModelCopyWith<$Res>? get compensationClaim;@override $TripWaitingSessionModelCopyWith<$Res>? get activeWaitingSession;
