...
mixin _$TripModel {
 ...
 String get id; String get referenceCode; String get status; double get quotedFare; String get currencyCode; DateTime get createdAtUtc; DateTime? get scheduledAtUtc; DateTime? get arrivedAtUtc; List<TripStopModel> get stops; String? get vehicleTypeName; double? get driverLat; double? get driverLng; DateTime? get etaToPickup; TripCancellationModel? get cancellation; TripRefundModel? get refund; TripRefundIssueModel? get refundIssue; TripCompensationClaimModel? get compensationClaim; TripWaitingSessionModel? get activeWaitingSession; String? get encodedOverviewPolyline; List<TripRouteSegmentModel> get routeSegments; String? get passengerNote; int? get passengerRating; String? get ratingComment; String? get acceptedByAdminId; String? get acceptedAdminName; DateTime? get acceptedAtUtc; bool get isScheduled; DateTime? get dispatchWindowOpensAtUtc; bool get canMarkEnRoute; String get attentionState; int get passengerCount; int get bagCount; bool get noDriverDecisionRequired;
...
@useResult
$Res call({
 String id, String referenceCode, String status, double quotedFare, String currencyCode, DateTime createdAtUtc, DateTime? scheduledAtUtc, DateTime? arrivedAtUtc, List<TripStopModel> stops, String? vehicleTypeName, double? driverLat, double? driverLng, DateTime? etaToPickup, TripCancellationModel? cancellation, TripRefundModel? refund, TripRefundIssueModel? refundIssue, TripCompensationClaimModel? compensationClaim, TripWaitingSessionModel? activeWaitingSession, String? encodedOverviewPolyline, List<TripRouteSegmentModel> routeSegments, String? passengerNote, int? passengerRating, String? ratingComment, String? acceptedByAdminId, String? acceptedAdminName, DateTime? acceptedAtUtc, bool isScheduled, DateTime? dispatchWindowOpensAtUtc, bool canMarkEnRoute, String attentionState, int passengerCount, int bagCount, bool noDriverDecisionRequired
});


$TripCancellationModelCopyWith<$Res>? get cancellation;$TripRefundModelCopyWith<$Res>? get refund;$TripRefundIssueModelCopyWith<$Res>? get refundIssue;$TripCompensationClaimModelCopyWith<$Res>? get compensationClaim;$TripWaitingSessionModelCopyWith<$Res>? get activeWaitingSession;
...
as TripCancellationModel?,refund: freezed == refund ? _self.refund : refund // ignore: cast_nullable_to_non_nullable
as TripRefundModel?,refundIssue: freezed == refundIssue ? _self.refundIssue : refundIssue // ignore: cast_nullable_to_non_nullable
as TripRefundIssueModel?,compensationClaim: freezed == compensationClaim ? _self.compensationClaim : compensationClaim // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$TripRefundModelCopyWith<$Res>? get refund {
    if (_self.refund == null) {
    return null;
  }

  return $TripRefundModelCopyWith<$Res>(_self.refund!, (value) {
...
@override
@pragma('vm:prefer-inline')
$TripRefundIssueModelCopyWith<$Res>? get refundIssue {
    if (_self.refundIssue == null) {
    return null;
  }

  return $TripRefundIssueModelCopyWith<$Res>(_self.refundIssue!, (value) {
...
class _TripModel implements TripModel {
  const _TripModel({required this.id, required this.referenceCode, required this.status, required this.quotedFare, required this.currencyCode, required this.createdAtUtc, this.scheduledAtUtc, this.arrivedAtUtc, final  List<TripStopModel> stops = const [], this.vehicleTypeName, this.driverLat, this.driverLng, this.etaToPickup, this.cancellation, this.refund, this.refundIssue, this.compensationClaim, this.activeWaitingSession, this.encodedOverviewPolyline, final  List<TripRouteSegmentModel> routeSegments = const [], this.passengerNote, this.passengerRating, this.ratingComment, this.acceptedByAdminId, this.acceptedAdminName, this.acceptedAtUtc, this.isScheduled = false, this.dispatchWindowOpensAtUtc, this.canMarkEnRoute = false, this.attentionState = 'Normal', this.passengerCount = 1, this.bagCount = 0, this.noDriverDecisionRequired = false}): _stops = stops,_routeSegments = routeSegments;
...
@override final  TripRefundModel? refund;
@override final  TripRefundIssueModel? refundIssue;
...
@override $TripCancellationModelCopyWith<$Res>? get cancellation;@override $TripRefundModelCopyWith<$Res>? get refund;@override $TripRefundIssueModelCopyWith<$Res>? get refundIssue;@override $TripCompensationClaimModelCopyWith<$Res>? get compensationClaim;@override $TripWaitingSessionModelCopyWith<$Res>? get activeWaitingSession;
...
mixin _$TripCancellationModel {
 ...
 String get actor; String get reason; double get refundPercent; double get refundAmount; String get currencyCode;/// Flat fee withheld from the fare. Defaulted for older payloads that predate the field.
...
@override
String toString() {
  return 'TripCancellationModel(actor: $actor, reason: $reason, refundPercent: $refundPercent, refundAmount: $refundAmount, currencyCode: $currencyCode, cancellationFeeAmount: $cancellationFeeAmount, note: $note, createdAtUtc: $createdAtUtc)';
}
...
class _TripCancellationModel implements TripCancellationModel {
  const _TripCancellationModel({required this.actor, required this.reason, required this.refundPercent, required this.refundAmount, required this.currencyCode, this.cancellationFeeAmount = 0, this.note, this.createdAtUtc});
...
/// @nodoc
mixin _$TripRefundModel {

 String get status; double get amount; String get currencyCode; DateTime? get completedAtUtc;
/// Create a copy of TripRefundModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$TripRefundModelCopyWith<TripRefundModel> get copyWith => _$TripRefundModelCopyWithImpl<TripRefundModel>(this as TripRefundModel, _$identity);

  /// Serializes this TripRefundModel to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TripRefundModel&&(identical(other.status, status) || other.status == status)&&(identical(other.amount, amount) || other.amount == amount)&&(identical(other.currencyCode, currencyCode) || other.currencyCode == currencyCode)&&(identical(other.completedAtUtc, completedAtUtc) || other.completedAtUtc == completedAtUtc));
}
...
@override
String toString() {
  return 'TripRefundModel(status: $status, amount: $amount, currencyCode: $currencyCode, completedAtUtc: $completedAtUtc)';
}
...
/// @nodoc
abstract mixin class $TripRefundModelCopyWith<$Res>  {
  factory $TripRefundModelCopyWith(TripRefundModel value, $Res Function(TripRefundModel) _then) = _$TripRefundModelCopyWithImpl;
@useResult
$Res call({
 String status, double amount, String currencyCode, DateTime? completedAtUtc
});
...
/// @nodoc
class _$TripRefundModelCopyWithImpl<$Res>
    implements $TripRefundModelCopyWith<$Res> {
  _$TripRefundModelCopyWithImpl(this._self, this._then);

  final TripRefundModel _self;
  final $Res Function(TripRefundModel) _then;
...
/// Adds pattern-matching-related methods to [TripRefundModel].
extension TripRefundModelPatterns on TripRefundModel {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TripRefundModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TripRefundModel() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TripRefundModel value)  $default,){
final _that = this;
switch (_that) {
case _TripRefundModel():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TripRefundModel value)?  $default,){
final _that = this;
switch (_that) {
case _TripRefundModel() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String status,  double amount,  String currencyCode,  DateTime? completedAtUtc)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TripRefundModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String status,  double amount,  String currencyCode,  DateTime? completedAtUtc)  $default,) {final _that = this;
switch (_that) {
case _TripRefundModel():
return $default(_that.status,_that.amount,_that.currencyCode,_that.completedAtUtc);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String status,  double amount,  String currencyCode,  DateTime? completedAtUtc)?  $default,) {final _that = this;
switch (_that) {
case _TripRefundModel() when $default != null:
return $default(_that.status,_that.amount,_that.currencyCode,_that.completedAtUtc);case _:
  return null;
...
class _TripRefundModel implements TripRefundModel {
  const _TripRefundModel({required this.status, required this.amount, required this.currencyCode, this.completedAtUtc});
  factory _TripRefundModel.fromJson(Map<String, dynamic> json) => _$TripRefundModelFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$TripRefundModelCopyWith<_TripRefundModel> get copyWith => __$TripRefundModelCopyWithImpl<_TripRefundModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$TripRefundModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TripRefundModel&&(identical(other.status, status) || other.status == status)&&(identical(other.amount, amount) || other.amount == amount)&&(identical(other.currencyCode, currencyCode) || other.currencyCode == currencyCode)&&(identical(other.completedAtUtc, completedAtUtc) || other.completedAtUtc == completedAtUtc));
}
...
/// @nodoc
abstract mixin class _$TripRefundModelCopyWith<$Res> implements $TripRefundModelCopyWith<$Res> {
  factory _$TripRefundModelCopyWith(_TripRefundModel value, $Res Function(_TripRefundModel) _then) = __$TripRefundModelCopyWithImpl;
@override @useResult
$Res call({
 String status, double amount, String currencyCode, DateTime? completedAtUtc
});
...
/// @nodoc
class __$TripRefundModelCopyWithImpl<$Res>
    implements _$TripRefundModelCopyWith<$Res> {
  __$TripRefundModelCopyWithImpl(this._self, this._then);

  final _TripRefundModel _self;
  final $Res Function(_TripRefundModel) _then;
...
/// Create a copy of TripRefundIssueModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$TripRefundIssueModelCopyWith<TripRefundIssueModel> get copyWith => _$TripRefundIssueModelCopyWithImpl<TripRefundIssueModel>(this as TripRefundIssueModel, _$identity);

  /// Serializes this TripRefundIssueModel to a JSON map.
  Map<String, dynamic> toJson();


@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TripRefundIssueModel&&(identical(other.id, id) || other.id == id)&&(identical(other.requestType, requestType) || other.requestType == requestType)&&(identical(other.status, status) || other.status == status)&&(identical(other.isOpen, isOpen) || other.isOpen == isOpen)&&(identical(other.createdAtUtc, createdAtUtc) || other.createdAtUtc == createdAtUtc)&&(identical(other.reviewedAtUtc, reviewedAtUtc) || other.reviewedAtUtc == reviewedAtUtc));
}
...
@override
String toString() {
  return 'TripRefundIssueModel(id: $id, requestType: $requestType, status: $status, isOpen: $isOpen, createdAtUtc: $createdAtUtc, reviewedAtUtc: $reviewedAtUtc)';
}
...
/// @nodoc
abstract mixin class $TripRefundIssueModelCopyWith<$Res>  {
  factory $TripRefundIssueModelCopyWith(TripRefundIssueModel value, $Res Function(TripRefundIssueModel) _then) = _$TripRefundIssueModelCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$TripRefundIssueModelCopyWithImpl<$Res>
    implements $TripRefundIssueModelCopyWith<$Res> {
  _$TripRefundIssueModelCopyWithImpl(this._self, this._then);

  final TripRefundIssueModel _self;
  final $Res Function(TripRefundIssueModel) _then;
...
/// Adds pattern-matching-related methods to [TripRefundIssueModel].
extension TripRefundIssueModelPatterns on TripRefundIssueModel {
/// A variant of `map` that fallback to returning `orElse`.
///
/// It is equivalent to doing:
/// ```dart
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TripRefundIssueModel value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TripRefundIssueModel() when $default != null:
return $default(_that);case _:
  return orElse();
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TripRefundIssueModel value)  $default,){
final _that = this;
switch (_that) {
case _TripRefundIssueModel():
return $default(_that);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TripRefundIssueModel value)?  $default,){
final _that = this;
switch (_that) {
case _TripRefundIssueModel() when $default != null:
return $default(_that);case _:
...
class _TripRefundIssueModel implements TripRefundIssueModel {
  const _TripRefundIssueModel({required this.id, required this.requestType, required this.status, required this.isOpen, required this.createdAtUtc, this.reviewedAtUtc});
  factory _TripRefundIssueModel.fromJson(Map<String, dynamic> json) => _$TripRefundIssueModelFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$TripRefundIssueModelCopyWith<_TripRefundIssueModel> get copyWith => __$TripRefundIssueModelCopyWithImpl<_TripRefundIssueModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$TripRefundIssueModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TripRefundIssueModel&&(identical(other.id, id) || other.id == id)&&(identical(other.requestType, requestType) || other.requestType == requestType)&&(identical(other.status, status) || other.status == status)&&(identical(other.isOpen, isOpen) || other.isOpen == isOpen)&&(identical(other.createdAtUtc, createdAtUtc) || other.createdAtUtc == createdAtUtc)&&(identical(other.reviewedAtUtc, reviewedAtUtc) || other.reviewedAtUtc == reviewedAtUtc));
}
...
/// @nodoc
abstract mixin class _$TripRefundIssueModelCopyWith<$Res> implements $TripRefundIssueModelCopyWith<$Res> {
  factory _$TripRefundIssueModelCopyWith(_TripRefundIssueModel value, $Res Function(_TripRefundIssueModel) _then) = __$TripRefundIssueModelCopyWithImpl;
@override @useResult
$Res call({
 String id, String requestType, String status, bool isOpen, DateTime createdAtUtc, DateTime? reviewedAtUtc
});
...
/// @nodoc
class __$TripRefundIssueModelCopyWithImpl<$Res>
    implements _$TripRefundIssueModelCopyWith<$Res> {
  __$TripRefundIssueModelCopyWithImpl(this._self, this._then);

  final _TripRefundIssueModel _self;
  final $Res Function(_TripRefundIssueModel) _then;
...
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? requestType = null,Object? status = null,Object? isOpen = null,Object? createdAtUtc = null,Object? reviewedAtUtc = freezed,}) {
  return _then(_TripRefundIssueModel(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,requestType: null == requestType ? _self.requestType : requestType // ignore: cast_nullable_to_non_nullable
as String,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as String,isOpen: null == isOpen ? _self.isOpen : isOpen // ignore: cast_nullable_to_non_nullable
...
@override
String toString() {
  return 'TripWaitingSessionModel(id: $id, tripId: $tripId, driverId: $driverId, startedAtUtc: $startedAtUtc, stoppedAtUtc: $stoppedAtUtc, minutes: $minutes, estimatedFee: $estimatedFee, isActive: $isActive, ratePerMinute: $ratePerMinute, graceMinutes: $graceMinutes, billableMinutes: $billableMinutes)';
}
...
class _TripWaitingSessionModel implements TripWaitingSessionModel {
  const _TripWaitingSessionModel({required this.id, required this.tripId, required this.driverId, required this.startedAtUtc, this.stoppedAtUtc, this.minutes, this.estimatedFee, this.isActive = false, this.ratePerMinute = 0, this.graceMinutes = 10, this.billableMinutes});
